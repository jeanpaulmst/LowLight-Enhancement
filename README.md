...
Tres sub-redes entrenadas conjuntamente: DecomNet (207k) + EnhanceNet/RelightNet con skip connections (237k) + DenoiseNet (225k). La loss combina reconstrucción, consistencia de reflectancia, suavidad de iluminación, pérdida perceptual VGG16, (1−SSIM) y consistencia de color.

- Parámetros totales: 670k

- Entrenamiento: 50 épocas, batch=8 (patches 128²), lr=2e-4, warmup lineal 5 épocas → CosineAnnealingLR
...
| RetinexNet + Denoise-Net e2e | 16.93 | 0.8124 |
